...
import { ensureApiUrl } from 'lib/utils/api'
import { APIMixin } from 'lib/model.mixins/api/mixin';
...
export class ApiHelper {
  ...
  constructor(controller: string) {
    this.baseURL = ensureApiUrl(controller)
  }
  ...
  public delete: APIHelperUpdateMethod = this.createRequestMethod(HTTPMethod.DELETE)
